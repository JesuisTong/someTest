  ...
  render() {
    return (
      <div className={s.body}>
        <button
          onClick={() => {
            import('./haha.js').then(console.log);
        ...
        <div
          style={{ fontSize: '50px', backgroundColor: this.state.show ? 'red' : 'blue' }}
          data-type
        >
          这里是一条内容
            ...
            <span className={s.couponBody}>
              ...
              <div className={s.cpb}>
                ...
                <span className={s['detail-btn']}>
                  详情
                  <i className="material-icons material-icons.md-24">keyboard arrow down</i>
                </span>
              </div>
            </span>
          </div>
        ...
        <CSSTransition
          ...
          in={this.state.show}
        >
          <div className={s.wry}>{'wryyyyyyyyyyyy'}</div>
        </CSSTransition>
        <RedPack />
        <div className={s['filp-container']}>
          <div className={s.flipper}>
            <div className={s.front}>
              <div className="openBtn">
                <div className="inner-circle">開</div>
              </div>
            </div>
